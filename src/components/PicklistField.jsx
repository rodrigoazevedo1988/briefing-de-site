  ...
  return (
    <div className="space-y-3">
      ...
      {!isMulti && selectedValues && (
        <div className="mt-2 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg flex items-center justify-between">
      ...
      {!isMulti && !selectedValues && <div className="mt-2 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg text-gray-400 dark:text-gray-500 text-sm">Selecione uma opção acima</div>}
    </div>
  )
}